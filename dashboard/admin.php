...
<body id="page-top">
    ...
    <h1 class="mt-5 fw-bold">Dashboard - <span class="fs-4 text-secondary"> <?php echo $day . " " . $dayOfMonth . " " . " " . $month . " " . $year; ?> </span></h1>
                    <div class="alert alert-info" role="alert">Selamat datang admin - <span class="text-capitalize fw-bold"><?php echo $_SESSION['username']; ?> </span> di Dashboard Madya Perpus Digital</div>
